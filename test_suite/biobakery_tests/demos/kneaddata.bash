...
kneaddata --unpaired input/singleEnd.fastq --output $OUTPUT_FOLDER/kneaddataOutputTrimmomatic2 --reference-db input/demo_db --trimmomatic-options="ILLUMINACLIP:/TruSeq3-SE.fa:2:30:10 SLIDINGWINDOW:4:20 MINLEN:90"
kneaddata_read_count_table --input $OUTPUT_FOLDER/kneaddataOutputTrimmomatic/ --output $OUTPUT_FOLDER/kneaddata_read_count_table3.tsv
